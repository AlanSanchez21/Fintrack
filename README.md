# Fintrack
A CLI-based personal Portfolio tracker fetching in real-time the price of a stock. Returning the price and cost basis, considering the number of shares inputed. **This is a SIMULATION**
